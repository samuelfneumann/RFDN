...
class BaseN(nn.Module):
    """
    Class BaseN is the base network upon which RFDN is built upon. It contains
    the overall underlying architecture of the RFDN network. This class was
    adapted from the RFDN class which can be found at:
    ...
    def __init__(self, in_nc=3, nf=50, num_modules=4, out_nc=3, upscale=4):
        ...
        self.B1 = B.BaseB(in_channels=nf)
        self.B2 = B.BaseB(in_channels=nf)
        self.B3 = B.BaseB(in_channels=nf)
        self.B4 = B.BaseB(in_channels=nf)
